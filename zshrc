name="The.AnaKen"
source ~/.zsh-ext/zsh-autocomplete/zsh-autocomplete.plugin.zsh
...
# Prompt
prompt="%B%F{red}┌(%f%F{green}%n%F{red})-%F{red}[%F{magenta}%(6~.%-1~/…/%4~.%5~)%f%F{red}]%f%F{yellow}"' ${vcs_info_msg_0_}'"%f"$'\n'"%F{red}└╼%f%F{yellow}$%f%b "
